    ...
    <div className="pt-24 pb-32">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-12 gap-12 items-center mb-24">
          ...
          >
            <div className="relative w-full max-w-md aspect-square rounded-2xl bg-gradient-to-br from-cyan-500/10 via-slate-900/80 to-emerald-500/10 border border-cyan-500/30 p-6 flex items-center justify-center shadow-[0_0_50px_rgba(6,182,212,0.15)] overflow-hidden">
